...
function Start-OpenNowProxyTunnel {
    ...
    # Asegurar bore.exe para túnel TCP sin configuración
    ...
    # Iniciar Micro-Proxy HTTP CONNECT en localhost:8080 si no existe
...
if ($env:TUNNEL_CMD -eq "tunnel") {
    ...
    Write-Host "[*] Presiona Ctrl+C o cierra esta ventana para detener el túnel." -ForegroundColor Gray
